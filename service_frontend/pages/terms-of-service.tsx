    ...
    return (
        <>
            ...
            <Container>
                ...
                <p>
                    This policy for the EOSC benchmark collection service is valid as of October
                    2021.
                </p>
                <p>
                    This Acceptable Use Policy and Conditions of Use (“AUP”) defines the rules and
                    conditions that govern your access to and use (including transmission,
                    processing, and storage of data) of the resources and services (“Services”) as
                    granted by the department{' '}
                    <a href="https://www.scc.kit.edu/en/aboutus/d3a.php">
                        Data Analytics, Access and Applications
                    </a>{' '}
                    (D3A) from the{' '}
                    <a href="https://www.scc.kit.edu/en/">Steinbuch Centre for Computing</a> (SCC)
                    of{' '}
                    <a href="https://www.kit.edu/english/index.php">
                        Karlsruhe Institute of Technology
                    </a>{' '}
                    (KIT), located at Hermann-von-Helmholtz-Platz 1, 76344 Eggenstein-Leopoldshafen
                    (the “Provider”) for the purpose of uploading, retrieving and comparing results
                    from benchmarks for diverse computing resources.
                </p>
                ...
                <ol>
                    ...
                    <ol type="a">
                        <li>
                            ...
                            resulting from, any content created or uploaded by you
                            (&quot;Content&quot;) to the Services.
                        </li>
                        <li>
                            You agree that you will only submit Content that you have the right to
                        ...
                        <li>
                            You grant us and our legal successors the right to store, archive,
                            parse, and display Your Content, and make incidental copies, as
                ...
                <p>
                    The KIT Impressum is found here:{' '}
