...
function CodeGuidelines(): ReactElement {
    return (
        <Container>
            ...
            <h2>Result Json</h2>
            <p>
                You may submit templates for the results as JSON Schemas to prevent
                unrelated or invalid JSON files from being uploaded. Below is a example
                JSON schema, which is containing the minimum set of required output
                parameters.
            </p>
            ...
            <p>
                To have a field show up as a suggested field to the user for filtering,
                add <code>&quot;suggestToUser&quot;: true</code> to the property in JSON
                Schema, like in the example below.
            </p>
