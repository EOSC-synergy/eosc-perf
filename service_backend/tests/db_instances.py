...
benchmarks[0]['upload_verdict'] = True
...
benchmarks[1]['upload_verdict'] = True
...
results[1]['reports'] = [
    ...
    {'message': "Report 2", 'verdict': None},
    {'message': "Report 3", 'verdict': False},
